			...
			<fo:page-sequence master-reference="A4" border-style="solid">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block font-size="10pt" text-align="center" space-after="10mm">
						<fo:block font-weight="bold" space-after="1mm">PERCORSI DI ISTRUZIONE E FORMAZIONE PROFESSIONALE (IeFP) II ANNO – A.F. 2015/2016</fo:block>
					...
					<fo:block font-size="9pt" text-align="justify">
						...
						<fo:inline font-weight="bold"> PERCORSI DI ISTRUZIONE E FORMAZIONE PROFESSIONALE (IeFP) II ANNO – A.F. 2015/2016</fo:inline>
