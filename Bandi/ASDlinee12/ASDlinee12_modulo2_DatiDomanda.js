...
fieldsets.get('349b3e802ba94e62a68d4baf8504e94a').setHidden(!provinciaDichiarata);
...
var provinceLombarde = dizionarioService.getMap(anagrafica,'03');
...
if (values.get('SedeLegale_DomandaPerFuoriRegione') == 'true') {
  ...
  if (values.get('SedeLegaleDichiarata_Comune') == '') {
    errors.put('SedeLegaleDichiarata_Comune','SedeLegaleDichiarata_Comune');
  }
}
fieldsets.get('349b3e802ba94e62a68d4baf8504e94a').setHidden(!provinciaDichiarata);
items.get('SedeLegaleDichiarata_Indirizzo').setRequired(provinciaDichiarata);
...
items.get('SedeLegaleDichiarata_Comune').setRequired(provinciaDichiarata);
  //formato IBAN
if (!isValidIbanIta(values.get('CoordinateBancarie_Iban'))) {
  errors.put('CoordinateBancarie_Iban','CoordinateBancarie_Iban_val');
}
