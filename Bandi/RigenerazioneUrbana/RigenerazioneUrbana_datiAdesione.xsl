    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="Arial, Helvetica, sans-serif">
      ...
      <fo:page-sequence master-reference="A4">
        <fo:flow flow-name="xsl-region-body">
          ...
          <fo:block font-size="14pt" font-weight="bold" text-align="center" space-after="10mm">Requisiti minimi di accesso</fo:block>
          ...
          <fo:block break-before="page" font-size="16pt" font-weight="bold" text-align="center" space-after="5mm">2 di 5 - Dati della domanda</fo:block>
            ...
            <fo:table-body>
              <fo:table-row>
                ...
                <fo:table-cell font-size="11pt" padding="1mm">
                  <fo:block>
                    <xsl:choose>
                      <xsl:when test="/_/Richiedente_Rup[text()='rappresentante']">Il rappresentante legale</xsl:when>
                      <xsl:when test="/_/Richiedente_Rup[text()='firmatario']">Il firmatario</xsl:when>
                      <xsl:when test="/_/Richiedente_Rup[text()='false']">Nessuno dei precedenti</xsl:when>
                    </xsl:choose>
                  </fo:block>
                </fo:table-cell>
              </fo:table-row>
          ...
          <fo:block break-before="page" font-size="16pt" font-weight="bold" text-align="center" space-after="5mm">3 di 5 - Dati del progetto</fo:block>
          <fo:block font-size="14pt" font-weight="bold" text-align="center" space-after="10mm">Dati del progetto</fo:block>
          ...
          <fo:table table-layout="fixed" width="170mm" space-after="2mm" border-spacing="0pt 2pt" border-bottom-style="solid">
            ...
            <fo:table-body>
              ...
              <fo:table-row>
                ...
                <fo:table-cell font-size="11pt" padding="1mm">
                  <fo:block><xsl:value-of select="/_/Richiedente_Tipologia" /></fo:block>
                </fo:table-cell>
              </fo:table-row>
              <fo:table-row>
                <fo:table-cell font-size="11pt" padding-before="1mm" padding-after="1mm">
              ...
              <xsl:if test="/_/TipologiaPartenership">
                <fo:table-row>
                  <fo:table-cell font-size="11pt" padding-before="1mm" padding-after="1mm">
          ...
          <fo:block break-before="page" font-size="16pt" font-weight="bold" text-align="center" space-after="5mm">4 di 5 - Documenti</fo:block>
          ...
          <fo:block break-before="page" font-size="16pt" font-weight="bold" text-align="center" space-after="5mm">5 di 5 - Presentazione domanda</fo:block>
          <fo:block font-size="14pt" font-weight="bold" text-align="center" space-after="10mm">Documenti</fo:block>
